...
<html id="top">
	...
	<body>
		...
		<header id="fh5co-header-section" class="sticky-banner">
			...
			<h2 class="container animate-box" id="Choose">Our Team</h2>
			<div class="container animate-box">
				<div class="row">
					<div class="col-md-3 col-sm-6 col-xs-6" id="img_row">
						<img src="images/me.jpg" width="230" class="img-responsive" id="img">
					</div>
					<div class="col-md-3 col-sm-6 col-xs-6" id="img_row">
						<img src="images/me.jpg" width="230" class="img-responsive" id="img">
					</div>
