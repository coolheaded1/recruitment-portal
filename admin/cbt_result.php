...
if(isset($_GET['id'])){
	if(isset($_POST)){
		$sql = "DELETE FROM cbt WHERE id = '$_GET[id]' ";
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-3 col-sm-3 col-xs-10 navbar-fixed-top" id="dash-area" style="display: none;"><br>
				...
				<abbr title="View Applicants"><a href="applicants.php"><span id="dash" data-aos="slide-right" data-aos-duration="350"><span class="fa fa-user"></span>&nbsp;&nbsp;Applicants</span></a></abbr><br /><br /><br />
				...
				<abbr title="View CBT Result"><a href="cbt_result.php"><span id="dash" style="background: orange"><span class="fa fa-recycle"></span>&nbsp;&nbsp;CBT Result
				<?php
					$sel = "SELECT * FROM cbt";
					$res = $conn->query($sel);
				 	$total = $res->num_rows; 
			...
			<div class="col-md-12 col-sm-12 col-xs-12" id="dash-area2"><br>
				<p>Dashboard / <a style="cursor: pointer;">CBT Result</a></p><br>
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-condensed">
						...
						while ($row = $res->fetch_assoc()) {
							echo "<tr>";
								echo "<td style='width: 150px' class='active success'>".$row['name']."</td>";
								echo "<td><p><a href='www.$row[email]' target = _blank>".$row['email']."</a></p></td>";
								echo "<td class='active success'>".$row['job']."</td>";
								echo "<td>".$row['score']."</td>";
								echo "<td class='active success' style='width: 100px'>".date('d-M-y', strtotime($row['dt']))."</td>";
								echo "<td><a style='color: #fff; text-decoration: none' href='cbt_result.php?id=$row[id];' title='Delete'><p style='border-radius: 5px; padding: 5px; text-align: center; background: #D55808;'>Delete</p></a></td>";
							echo "</tr>";
						}
						?>
					</table>
